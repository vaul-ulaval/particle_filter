...
class ParticleFilter : public rclcpp::Node {
   public:
    ...
    void initializeParticlesPose(const geometry_msgs::msg::PoseWithCovarianceStamped &msg);
    ...
    void laser_odom_cb(const sensor_msgs::msg::LaserScan::ConstSharedPtr& msg, const nav_msgs::msg::Odometry::ConstSharedPtr& odom_msg);
    void clickedPose_cb(const geometry_msgs::msg::PoseWithCovarianceStamped::SharedPtr msg);
   ...
   private:
    ...
    std::shared_ptr<message_filters::Synchronizer<message_filters::sync_policies::ApproximateTime<sensor_msgs::msg::LaserScan, nav_msgs::msg::Odometry>>> laser_odom_ts_;
